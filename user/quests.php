    ...
    <div id="view-history" style="display:none;">
        ...
        <?php else: ?>
            ...
            <div style="padding: 60px 20px; text-align: center; color: #555; background: white; border-radius: 12px; box-shadow: 0 2px 5px rgba(0,0,0,0.05); max-width: 600px; margin: 0 auto;">
                ...
                <br>
                <a href="../login.php" class="btn-primary" style="padding: 12px 30px; display: inline-block; width: auto; text-decoration: none;">Login / Register</a>
            </div>
        ...
        <div id="modal-section-available" style="display:none;">
            ...
            <?php else: ?>
                <div style="margin-top: 20px; text-align: center;">
                    ...
                    <a href="../login.php" class="btn-primary" style="text-decoration:none; display:block; padding:12px 0;">Login to Participate</a>
                </div>
            <?php endif; ?>
        </div>
